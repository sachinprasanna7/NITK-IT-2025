...
int main(){
    ...
    int edgeInitial = generateRandom();
    int edgeFinal = generateRandom();
    int weight = generateRandom();
    ...
    while( i < 100000){
        ...
        if(isPresent(edgeInitial, edgeFinal, vec)){
            edgeInitial = generateRandom();
            edgeFinal = generateRandom();
            continue;
        }
